Feature: API_US_10 As a user, I want to access the list of loans via API connection.
  ...
  @API
  Scenario: user/list/loan' endpoint with the appropriate authorization credentials, it should return a status code of 200, and the response remark should be "success"

    * The API user sets "user/list/loan" path parameters
    * API user saves the response from the api categories list endpoint with valid authorization information
